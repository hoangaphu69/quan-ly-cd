...
public class GUITimKiemTinhNang extends JPanel{
	...
	public GUITimKiemTinhNang() {
		...
		cbb_timkiemphanloai.addItem("tac gia");
		cbb_timkiemphanloai.addItem("the loai");
		cbb_timkiemphanloai.addItem("ma cd");
		cbb_timkiemphanloai.addItem("ten");
		
		txt_tim = new JTextField(20);
		btn_tim = new JButton("Tim");
		pn_nouth.add(lb_timkiemphanloai);
		pn_nouth.add(cbb_timkiemphanloai);
		...
		cbb_timkiemphanloai.setPreferredSize(new Dimension(200, 30));
